...
const ModelStudyExperimentForm = ({
  ...
  // Ensure at least one pair exists on mount (only once)
    ...
    <Form {...form}>
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        <div className="space-y-3">
          ...
          <div className="border border-gray-200 p-3 rounded-md max-h-56 overflow-y-auto">
            {fields.map((field, index) => (
              <div key={field.id} className="flex items-end gap-3 w-full mb-2">
        ...
        <CellsInjectedField
          ...
          multiple={true}
        />
        <VehicleField control={form.control} name="vehicles" multiple={true} />
