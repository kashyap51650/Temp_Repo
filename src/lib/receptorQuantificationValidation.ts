...
export const ReceptorQuantificationFormDataSchema = z
  .object({
  ...
  .refine(
    (data) =>
      data.secondaryAntibody === undefined ||
      data.primaryAntibody !== data.secondaryAntibody,
    {
      message: "Primary and secondary antibody cannot be the same",
      path: ["secondaryAntibody"],
    }
  );
